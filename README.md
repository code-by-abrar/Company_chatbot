...
* **Modern "Elementra" Frontend:** A beautiful, responsive split-screen UI built with HTML/CSS/JS. Features include markdown parsing, animated typing indicators, and floating UI elements.
